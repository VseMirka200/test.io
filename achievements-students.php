<?php
$dir = __DIR__ . '/assets/img/achievements/students';
$images = [];
...
<head>
  ...
  <title>Достижения студентов — Портфолио</title>
...
<body>
        ...
        <nav class="nav" data-nav>
          ...
          <div class="dropdown open" data-dropdown>
            ...
            <div class="dropdown-panel">
              <a href="achievements-teacher.php">Преподавателя</a>
              <a class="active" href="achievements-students.php">Студентов</a>
            </div>
          </div>
  ...
  <main class="container">
    <h1 class="page-title">Достижения студентов</h1>
    <p class="subtitle">Грамоты, дипломы и результаты участия в конкурсах и олимпиадах</p>

    <section class="section">
      <h2>Документы и результаты</h2>

      <?php if (count($images) === 0): ?>
        <p class="meta">Пока нет изображений. Добавьте файлы в папку <b>assets/img/achievements/students</b>.</p>
      <?php else: ?>
        <div class="gallery">
          <?php foreach ($images as $path):
            $file = basename($path);
            $url = 'assets/img/achievements/students/' . $file;
      ...
      <p class="meta" style="margin-top:12px">Совет: используйте понятные имена файлов (например, <b>2025-olimpiada</b> или <b>diplom-2024</b>).</p>
